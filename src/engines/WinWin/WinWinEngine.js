...
import { RED_NUMBERS } from '../../utils/numberMeta.js';
import { winwinHistoricalMaxesStore } from '../../../winwinHistoricalMaxesStore.js';

export class WinWinEngine extends BaseEngine {
  constructor(tracker) {
    super('WinWin');
  ...
  async initialize() {
    // Lifecycle stub — override for custom init logic
  }

  async start() {
    // Lifecycle stub — override for custom start logic
  }

  async stop() {
    // Lifecycle stub — override for custom stop logic
  }

  async dispose() {
    // Lifecycle stub — override for custom dispose logic
  }
  ...
  rescanFullHistory(spins, customSeries = []) {
    ...
    this.historicalMaxes = { externals: {}, dozens: {}, seisenas: {}, series: {}, plenos: {} };
  ...
  getCHIDetails() {
    ...
    // Construir mapa de frecuencias desde API pública getSpins()
    const freqMap = {};
